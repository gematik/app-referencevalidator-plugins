...
class DependencyExtractorTests {
  ...
  void testGetAllDependenciesFromPackageJson() {
    List<FhirPackage> dependencies =
        dependencyExtractor.getAllDependenciesFromPackageJson(
            List.of(new File("src/test/resources/package/minimalvalidationmodule.test-1.0.0.tgz")));
  ...
  void testNoDependenciesFromPackageJson() {
    List<FhirPackage> dependencies =
        dependencyExtractor.getAllDependenciesFromPackageJson(
            List.of(
                new File(
                    "src/test/resources/package-with-no-dependencies/minimalvalidationmodule.test-1.0.0.tgz")));
  ...
  void testGetAllDependenciesFromPackageJsonThrowsException() {
    assertThrows(
        DependencyExtractionException.class,
        () ->
            dependencyExtractor.getAllDependenciesFromPackageJson(
                List.of(
                    new File(
                        "src/test/resources/corrupted-package/minimalvalidationmodule.test-1.0.0-corrupted-package-json.tgz"))));
  }
}
